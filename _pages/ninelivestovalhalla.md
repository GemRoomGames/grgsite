...
{% include figure image_path="{{ site.url }}assets/ninelives/advance_praise_header_trimmed.png" alt="Advanced Praise for 9 Lives to Valhalla" caption="seriously?" %}<br>
